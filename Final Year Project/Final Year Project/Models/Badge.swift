...
extension Badge {
    ...
    [
        Badge(title: "Badge 1", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec posuere risus massa, eu pharetra ipsum pretium non. Nunc id mi sed ante maximus iaculis. Phasellus at ante a magna luctus tempor id ac eros. Nullam venenatis id sapien fermentum scelerisque. Mauris a leo turpis. Ut eget imperdiet augue. Vivamus vulputate quis felis ac cursus.", achieveBy: "Earn 5000 points to unlock.", image: "badge0", earned: true),
        Badge(title: "Badge 2", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec posuere risus massa, eu pharetra ipsum pretium non. Nunc id mi sed ante maximus iaculis. Phasellus at ante a magna luctus tempor id ac eros. Nullam venenatis id sapien fermentum scelerisque. Mauris a leo turpis. Ut eget imperdiet augue. Vivamus vulputate quis felis ac cursus.", achieveBy: "Earn 5000 points to unlock.", image: "badge1", earned: true),
        Badge(title: "Badge 3", description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec posuere risus massa, eu pharetra ipsum pretium non. Nunc id mi sed ante maximus iaculis. Phasellus at ante a magna luctus tempor id ac eros. Nullam venenatis id sapien fermentum scelerisque. Mauris a leo turpis. Ut eget imperdiet augue. Vivamus vulputate quis felis ac cursus.", achieveBy: "Earn 5000 points to unlock.", image: "badge2", earned: false),
